import { createMemo, mergeProps, type Component, type JSX } from 'solid-js'

const CheckedIcon: Component = () => (
...
const Checkbox: Component<CheckboxProps> = (props) => {
  ...
  const isChecked = createMemo(() => merged.checked)
  ...
  return (
    <div
      style={props.style}
      class={`klinecharts-pro-checkbox ${isChecked() ? 'checked' : ''} ${props.class || ''}`}
      role="checkbox"
